    ...
    <div className="mt-[72.5px] overflow-hidden">
      ...
      <div className="flex justify-between p-4">
        <div className="w-1/2 flex items-center">
          <button className="bg-blue-300/50 border border-gray-400 py-2 px-4">
            جستجو
          </button>
          <input
            placeholder="قسمتی از عنوان را وارد کنید"
            type="text"
            className="focus:outline-none p-2 w-4/5 md:w-1/2 border border-gray-400"
          />
        </div>
        <div
          onClick={() => {
          ...
          className="bg-green-700 text-white p-3 rounded-md cursor-pointer"
        >
