                                ...
                                {props => {
                                    return (
                                        <div className="relative w-3/4 md:w-1/2">
                                            <div onClick={() => { setIsOpen((prev) => !prev) }} className=" bg-white text-start gap-1 flex items-center px-2 h-full text-gray-400">
                                            ...
                                            {isOpen && <div className={`focus:outline-none p-2 border shadow-2xl border-gray-400 absolute bg-gray-100 w-full top-11`}>
                                                <input onChange={(e) => { filterChildArray(e.target.value) }} className="w-full border-0 outline-none bg-inherit border-b border-gray-300 pb-1" type="text" placeholder="قسمتی از عنوان مورد نظر را وارد کنید" />
