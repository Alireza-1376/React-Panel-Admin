...
import ModalQuestions from "./ModalQuestion";
...
const Questions = () => {
    ...
    const data = [
        {
            ...
            questionType: "پرسش",
            class: "محصولات",
            text: "قسمتی از متن سوال برای این محصول مثلا 100 کارکتر",
            date: "1404/10/08",
        }
    ...
    const dataInfo = [
        ...
        { field: "questionType", value: "نوع سوال" },
        { field: "class", value: "دسته" },
    ...
    return (
        <div>
            <div className="mt-[72.5px] overflow-hidden">
                <h2 className="text-center text-2xl py-6">مدیریت سوالات</h2>

                <div id="products-table" className="m-4 overflow-x-auto">
                    <Tabel status={status} numOfData={2} data={data} dataInfo={dataInfo} tabelActions={tabelActions} title="جستجو" placeholder="قسمتی از نام یا نام خانوادگی یا سوال را وارد کنید" />
                </div>
